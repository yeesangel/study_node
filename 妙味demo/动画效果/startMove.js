function css(e, t, a) {
  if (2 == arguments.length) {
    if (
      ...
      switch ((e.$Transform || (e.$Transform = {}), t)) {
        case "scale":
        case "scaleX":
        case "scaleY":
  ...
  if (30 > n) for (m in a) css(t, m, a[m]);
    ...
    t.timer = setInterval(function() {
      if (l > i) {
        i++;
        for (m in a)
          (h[m] = o(i, u[m], f[m], l)), css(t, m, o(i, u[m], f[m], l));
      } else {
...
var Tween = {
  ...
  elasticOut: function(e, t, a, n, r, s) {
    ...
    return (
      r * Math.pow(2, -10 * e) * Math.sin((2 * (e * n - c) * Math.PI) / s) +
      a +
      t
    );
  },
  elasticBoth: function(e, t, a, n, r, s) {
    ...
    if ((s || (s = 0.3 * n * 1.5), !r || r < Math.abs(a))) {
      r = a;
      var c = s / 4;
    } else var c = (s / (2 * Math.PI)) * Math.asin(a / r);
    return 1 > e
  ...
  backIn: function(e, t, a, n, r) {
    return (
      "undefined" == typeof r && (r = 1.70158),
      a * (e /= n) * e * ((r + 1) * e - r) + t
    );
  },
  backOut: function(e, t, a, n, r) {
    return (
      "undefined" == typeof r && (r = 3.70158),
      a * ((e = e / n - 1) * e * ((r + 1) * e + r) + 1) + t
    );
  },
  backOut1: function(e, t, a, n, r) {
    return (
      "undefined" == typeof r && (r = 1.5),
      a * ((e = e / n - 1) * e * ((r + 1) * e + r) + 1) + t
    );
  },
  backBoth: function(e, t, a, n, r) {
    return (
      "undefined" == typeof r && (r = 1.70158),
      (e /= n / 2) < 1
        ? (a / 2) * e * e * (((r *= 1.525) + 1) * e - r) + t
        : (a / 2) * ((e -= 2) * e * (((r *= 1.525) + 1) * e + r) + 2) + t
    );
  },
  ...
  bounceBoth: function(e, t, a, n) {
    return n / 2 > e
      ? 0.5 * Tween.bounceIn(2 * e, 0, a, n) + t
      : 0.5 * Tween.bounceOut(2 * e - n, 0, a, n) + 0.5 * a + t;
  }
};
