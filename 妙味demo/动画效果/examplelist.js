$(document).ready(function(){
    ...
    $cuBox.on('mouseenter',function () {
        ...
        tweenMove({obj:$this.get(0),oTarget:{'width' : '240'},iTime:200,iType:'linear',fnEnd:function () {
    ...
    $cuBox.on('mouseleave',function () {
        ...
        $this.get(0).iTimer = setTimeout(function () {
            tweenMove({obj:$this.get(0),oTarget:{'height' : '48'},iTime:400,iType:'linear',fnEnd:function () {
                tweenMove({obj:$this.get(0),oTarget:{'width' : '116'},iTime:200,iType:'linear',fnEnd:function () {
    ...
    $psBox.on('mouseleave',function () {
        ...
        clearTimeout($this.get(0).iTimer);
        $this.get(0).iTimer = setTimeout(function () {
            tweenMove({obj: $this.get(0), oTarget: {'height': '48'}, iTime: 300, iType: 'linear', fnEnd: function () {
